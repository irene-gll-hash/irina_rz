...
def report(
    ...
    top_k: int = typer.Option(5, help="Кол-во top значений для категориальных признаков."),
    title: str = typer.Option("EDA-отчёт", help="Заголовок отчёта."),
    min_missing_share: float = typer.Option(0.3, help="Порог доли пропусков для пометки проблемных колонок."),
) -> None:
    """
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Колонок с пропусками > порога: **{problem_count}**\n\n")
